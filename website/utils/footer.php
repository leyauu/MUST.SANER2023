            ...
            <div class="col-md-3 col-md-offset-1 padd">
                ...
                <address>
                    <p>
                        ...
                        <i class="fa fa-phone"></i>&nbsp;(+853) 2888 1122<br>
                        <i class="fa fa-envelope"></i>&nbsp;<a href="mailto:pr@must.edu.mo">pr@must.edu.mo</a>
                    </p>
                </address>

                <a href="<?php echo FACEBOOK; ?>" target="_blank" class="social-icon-jump-x4 rounded">
                    <div>
                        <i class="fa fa-wechat facebook-icon-jump"></i>
                        <i class="fa fa-wechat social-icon-jump-dark"></i>
                    </div>
                </a>
