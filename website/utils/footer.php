    ...
    <div class="container footer" style="width: 100%; padding-left: 50px; padding-right: 50px;">
        <div class="row">
            ...
            <div class="col-md-4 padd">
                ...
                <a href="https://github.com/MUST-ISDA/saner2018" target="_blank" class="social-icon-jump-x4 rounded">
                    <div>
                        <i class="fa fa-github github-icon-jump"></i>
                        <i class="fa fa-github social-icon-jump-dark"></i>
                    </div>
                </a>
            </div>
